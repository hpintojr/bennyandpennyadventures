...
export async function sendCartRecoveryEmail(opts: {
  ...
  // No heart character here: Sequenzy converts Unicode hearts inside links into a red emoji image.
  // These three white shapes render as one small white heart in Gmail and stay inside the CTA button.
  const whiteCtaHeart = `<span aria-hidden="true" style="display:inline-block;position:relative;width:9px;height:9px;margin-left:4px;vertical-align:-1px;"><span style="position:absolute;left:1px;top:3px;width:7px;height:7px;background:#ffffff;transform:rotate(45deg);"></span><span style="position:absolute;left:1px;top:0;width:6px;height:6px;background:#ffffff;border-radius:50%;"></span><span style="position:absolute;left:4px;top:0;width:6px;height:6px;background:#ffffff;border-radius:50%;"></span></span>`;
